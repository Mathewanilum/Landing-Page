...
export const createLinkUtils = ({
	...
	const getDocumentLinkProps = (documentUrl: string): LinkProps => {
		...
		const isPremiumDocumentLinkExperimentOn = experiments['specs.thunderbolt.premiumDocumentLink'] === true
		const isExcludeOriginForAllPremiumDomainExperimentOn =
			experiments['specs.thunderbolt.excludeOriginForAllPremiumDomain'] === true
		...
		return {
			...
			href: resolveDocumentLink(
				...
				isPremiumDomain,
				isPremiumDocumentLinkExperimentOn,
